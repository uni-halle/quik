...
#include "scramble.h"
#include "sequence_levenshtein_distance_v1.cuh"
...
int main(int argc, char** argv) {
    ...
    std::cout << "sequence_levenshtein_distance_v1" << "\t"
        << benchmark_sl_distance<sequence_levenshtein_distance_v1>(barcodes, reads) / reads.size() << "\t"
        << std::endl;
