...
struct two_step_k_mer_filtered_calling_gpu_v1 : public barcode_assignment {
...
private:
    barcode_assignment run(const std::vector <barcode> &barcodes,
        ...
        barcode_assignment ass_k_large =
            k_mer_filtered_calling_gpu_v5(barcodes, reads, k_large, distance_measure, rejection_threshold_large);
        ...
        barcode_assignment ass_k_small = k_mer_filtered_calling_gpu_v5(
            barcodes, unassigned_reads, k_small,
            distance_measure,
            rejection_threshold_small);
