...
namespace barcode_calling {
    ...
    class two_step_k_mer_filter_single_gpu_v2 :
        public k_mer_filter_single_gpu_default<k_large, distance_function> {

        typedef k_mer_filter_single_gpu_default<k_large, distance_function> super;

    public:

        two_step_k_mer_filter_single_gpu_v2(
        ...
        static std::string name() {
            return std::to_string(k_large) + "_" +
                std::to_string(k_small) + "_mer_filter_single_gpu_v2";
        }

        /**
         * Run the algorithm
         **/
        two_step_k_mer_filter_single_gpu_v2& run() override {
