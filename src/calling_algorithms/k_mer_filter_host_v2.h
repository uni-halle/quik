...
namespace barcode_calling {
    ...
    class k_mer_filter_host_v2 : public barcode_calling_algorithm {

        distance_function distance;

    public:
        explicit k_mer_filter_host_v2(
        ...
        static std::string name() {
            return std::to_string(k) + "_mer_filter_host_v2";
        }

        /**
         * Run the algorithm
         **/
        k_mer_filter_host_v2& run() override {
            ...
            k_mer_map_host<k> k_mer_map(barcodes);
...
#pragma omp atomic
                ...
                assign_as_1st_barcode(read_id, index[0].barcode_id, index[0].distance);
                assign_as_2nd_barcode(read_id, index[1].barcode_id, index[1].distance);
            }
