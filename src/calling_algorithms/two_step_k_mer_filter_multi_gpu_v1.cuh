...
namespace quik {
    ...
    class two_step_k_mer_filter_multi_gpu_v1 : public barcode_calling_algorithm {

        distance_function distance;

    public:
        two_step_k_mer_filter_multi_gpu_v1(
        ...
        static std::string name() {
            return std::to_string(k_large) + "_" +
                std::to_string(k_small) + "_mer_filter_multi_gpu_v1";
        }

        /**
         * Run the algorithm
         **/
        two_step_k_mer_filter_multi_gpu_v1& run() override {

            /************************************************************************************************
             * Start by calculating a barcode assignment using k_large-mers
             ************************************************************************************************/

            k_mer_filter_multi_gpu_default<k_large, distance_function>
            ...
            k_mer_filter_multi_gpu_default<k_small, distance_function>
                ass_k_small(barcodes, unassigned_reads, rejection_threshold, distance);
            ass_k_small.run();
